...
function displayAllSections() {
    ...
    for( var section of sections ) {
        ...
        section.querySelector('.linkHidden').style.display = 'block';
        section.querySelector('.stopTimer').style.display = 'none';
    }
}
...
if( window.location.hash.length > 0 ) {
    ...
    if ( _section != null ) {
        ...
        var hashSlices = hash.substring(1).split('_'),
        ...
        var timeFunction = setTimeout(function() {
            ...
            // var visited = window.open(_URL.getAttribute('href'), '_blank');
            // setTimeout(function () {
            //     visited.close();
            // }, 2000, visited);
