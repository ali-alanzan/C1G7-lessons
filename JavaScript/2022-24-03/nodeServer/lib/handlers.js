...
handlers._requests.get = function (data, callback) {
    ...
    var limit = typeof(data.queryStringObject.get('limit')) == 'string' && Number(data.queryStringObject.get('limit')) > 0 ? Number(data.queryStringObject.get('limit')) : Number(data.queryStringObject.get('limit')) == -1 ? Number(data.queryStringObject.get('limit')) : 3;     
